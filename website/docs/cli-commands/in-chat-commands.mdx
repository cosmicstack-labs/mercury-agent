...
| `/skills search <query>` | Search the registry at [skills.mercuryagent.sh](https://skills.mercuryagent.sh) |
| `/skills view <id>` | Show title, version, description, and registry URL for `<category>/<slug>` |
| `/skills install <id>` | Install a skill from the registry into `~/.mercury/skills/` |
