...
:::caution Beta
Kanban Boards are a beta feature in v1.1.8. The data model and API surface are stable, but expect UI refinements in subsequent releases. The web dashboard labels this section **"Kanban Boards (Beta mode)"**.
:::
