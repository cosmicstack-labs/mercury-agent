...
## No server? Run it in the cloud

Don't want to manage a daemon, service, or updates yourself? [Atomic Bot](https://atomicbot.ai/?utm_source=agent) offers fully hosted Mercury Code instances — your agent runs 24/7 on their infrastructure with zero setup, starting at $19/mo. See [Cloud Instance](/docs/getting-started/platforms/cloud-instance) for details.
